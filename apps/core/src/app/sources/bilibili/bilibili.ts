                ...
                if (typeof msg.info[0][13] === 'object') {
                  observer.next({
                      ...
                      nodes: [
                        {
                          ...
                          width: msg.info[0][13].width,
                          height: msg.info[0][13].height,
                        },
                      ],
                    },
                    avatar: '',
                    badges: [
                      ...[guardType[msg.info[7]]].filter(Boolean), // TODO: custom badge
                    ],
                    ...
                    usertype:
                      ...
                      (msg.info[2][0] == resp.roomInfo.uid ? 0x04 : 0x0),
                  ...
                  observer.next({
                    ...
                    price:
                      msg.data.coin_type == 'gold'
                        ...
                        : 0,
                    platformPrice:
                      msg.data.coin_type == 'silver' ? msg.data.total_coin : 0,
