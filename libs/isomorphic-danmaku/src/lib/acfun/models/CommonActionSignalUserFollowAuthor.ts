...
const baseCommonActionSignalUserFollowAuthor: object = {
  sendTimeMs: Long.ZERO,
};

export const protobufPackage = 'AcFunDanmu'

export const CommonActionSignalUserFollowAuthor = {
  encode(message: CommonActionSignalUserFollowAuthor, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Uint8Array | Reader, length?: number): CommonActionSignalUserFollowAuthor {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseCommonActionSignalUserFollowAuthor } as CommonActionSignalUserFollowAuthor;
  ...
  fromJSON(object: any): CommonActionSignalUserFollowAuthor {
    const message = { ...baseCommonActionSignalUserFollowAuthor } as CommonActionSignalUserFollowAuthor;
  ...
  fromPartial(object: DeepPartial<CommonActionSignalUserFollowAuthor>): CommonActionSignalUserFollowAuthor {
    const message = { ...baseCommonActionSignalUserFollowAuthor } as CommonActionSignalUserFollowAuthor;
    if (object.userInfo !== undefined && object.userInfo !== null) {
  ...
  toJSON(message: CommonActionSignalUserFollowAuthor): unknown {
    const obj: any = {};
