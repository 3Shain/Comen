...
export type CustomConditionExpressionGenerator = (
  operateExpression: estree.Expression,
  method: string,
  target: SafeAny
) => estree.Expression;
...
function generateStringConditionExpression(
  operateExpression: estree.Expression,
  method: string,
  target: SafeAny
): estree.Expression {
    ...
    case 'tnct':
      return {
        ...
        left: {
          ...
          arguments: [generateObjectExpression(target)],
        },
...
function generateObjectExpression(constObject: SafeAny): estree.Expression {
  if (
    typeof constObject == 'string' ||
    typeof constObject == 'number' ||
    typeof constObject == 'bigint' ||
    typeof constObject == 'boolean'
  ) {
  ...
  return ensureAccessable(
    ...
    (() => {
      ...
      if (CUSTEM_CONDITION_EXPRESSION_GENERATOR[condition.method]) {
        CUSTEM_CONDITION_EXPRESSION_GENERATOR[condition.method](
          operatee,
          condition.method,
          condition.target
        );
      ...
      if (BINARY_OPERATIONS_MAP[condition.method]) {
        ...
        return generateStringConditionExpression(
          operatee,
          condition.method,
          condition.target
        );
...
function generateVariantConditions(
...
function generateVariantStatements(
  variants: {
    condition: VariantCondition[];
    properties: SafeAny;
  }[]
